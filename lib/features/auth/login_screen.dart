        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              HeightSpace(3.h,),
              Text('It’s great to see you again.',style: AppTextStyle.thirdText,),
              HeightSpace(30.h),
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      style: AppTextStyle.thirdText
                          .copyWith(color: AppColors.Primary_400),
                      children: [
                        TextSpan(
                            text: "Join", style: AppTextStyle.thirdText.copyWith(color: AppColors.Primary_900))
                      ],
                    ),
                  ),
                ),
